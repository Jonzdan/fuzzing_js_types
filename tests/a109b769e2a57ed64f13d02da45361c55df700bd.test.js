...
var fn4 = function() { return true }
  signal.add(fn0, null, 2);
  signal.add(fn0, null, 0);
  signal.add(fn2, null, 1);
  signal.dispatch(true, {"x":127});
  signal.dispatch({"x":127}, true);
  signal.addOnce(fn2, null, 2);
  signal.addOnce(fn3, null, 3);
  signal.addOnce(fn2, null, 2);
  ...
  signal.addOnce(fn2, null, 2);
  signal.addOnce(fn3, null, 3);
  signal.addOnce(fn1, null, 2);
  signal.addOnce(fn4, null, 3);
  signal.dispatch({"x":127}, {"x":127});
  signal.remove(fn3);
  signal.dispatch({"x":127}, {"x":127});
  signal.dispatch({"x":127}, true);
  signal.addOnce(fn2, null, 2);
  ...
  signal.addOnce(fn2, null, 2);
  signal.addOnce(fn3, null, 3);
  signal.addOnce(fn0, null, 2);
  signal.addOnce(fn2, null, 4);
  signal.dispatch({"x":127}, {"x":127});
  signal.halt();
  signal.remove(fn1);
  signal.remove(fn0);